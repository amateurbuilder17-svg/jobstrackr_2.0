...
export default tseslint.config(
  {
    ignores: [
      ...
      "next-env.d.ts",
      "supabase/**",
      // Agent worktrees. Each is a full checkout of this repo, so without this
      // every file gets linted twice — and the copies sit outside the tsconfig
      // program, so the type-aware rules abort the whole run rather than skip
      // them. Git already excludes the directory; ESLint needs telling too.
      ".claude/**",
