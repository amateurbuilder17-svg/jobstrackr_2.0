...
/**
 * Page 2 and beyond of a state hub.
 *
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return hubRouteMetadata("state", slug, n);
}

export default async function StateHubPageN({ params }: { params: Params }) {
  const { slug, n } = await params;
  return renderHubRoute("state", slug, n);
}
