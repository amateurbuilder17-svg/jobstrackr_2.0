...
/**
 * Page 2 and beyond of an organisation hub.
 *
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return hubRouteMetadata("organisation", slug, n);
}

export default async function OrganisationHubPageN({ params }: { params: Params }) {
  const { slug, n } = await params;
  return renderHubRoute("organisation", slug, n);
}
